// api/notifications/send-new-project-admin.js
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const emailSubject = `🆕 New Project Submission: ${projectData.projectTitle || 'Unknown Project'}`;
    ...
    const htmlTemplate = `
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <title>New Project Submission - Admin Notification</title>
          <style>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>A new project has been submitted to the platform and requires your approval.</p>
              ...
              <div class="project-details">
                ...
                ${projectData.requiredSkills ? `<p><strong>Required Skills:</strong> ${projectData.requiredSkills}</p>` : ''}
                ${projectData.maxTeamSize ? `<p><strong>Max Team Size:</strong> ${projectData.maxTeamSize} members</p>` : ''}
              </div>
              ...
              <ol>
                ...
                <li><strong>Team group will be auto-created</strong> upon approval</li>
              </ol>
    ...
    const textVersion = `
New Project Submission: ${projectData.projectTitle || 'Unknown Project'}

Hello Admin,

A new project has been submitted to the platform and requires your approval.
...
${projectData.requiredSkills ? `- Required Skills: ${projectData.requiredSkills}` : ''}
${projectData.maxTeamSize ? `- Max Team Size: ${projectData.maxTeamSize} members` : ''}
...
The Favored Online System
    ...
    return res.status(200).json({ 
      ...
      results: [{ 
        type: 'new_project_submission_admin',
