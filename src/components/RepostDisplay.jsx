      ...
      >
                  ...
                  {taggedUsers.map((user) => (
                    <div key={user.uid} className="flex items-center space-x-2 bg-lime-400/10 rounded-full px-3 py-1">
                      ...
                      <div className="flex flex-col">
                        ...
                        {user.profile?.title && (
                          <span className="text-lime-400/70 text-xs">
                            {user.profile.title}
                          </span>
                        )}
                      </div>
        ...
        <div className="p-6 border-t border-white/10 bg-black/20">
          <div className="flex items-center justify-between">
            <div className="text-gray-400 text-sm">
              {taggedUsers.length > 0 && (
                <span>Will notify {taggedUsers.length} mentioned professional{taggedUsers.length > 1 ? 's' : ''} • </span>
              )}
              This will be shared with your network
            </div>
